...
def main():
    ...
    print('Se ha generado el archivo .lp')
    
    print('Resolviendo...')
    try:
        sub.run(['lp_solve.exe', '-time', 'LPModel.lp', '>solucion.txt'], shell = True, check = True, timeout=60)
        print('Se creó el archivo con la solución')
    except sub.TimeoutExpired:
        print('El problema no tiene solución o sobrepasó el tiempo de ejecución')
        return 1
